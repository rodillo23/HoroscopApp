...
import com.example.horoscopapp.ui.lucky.model.LuckyModel
...
class RandomCardsProvider @Inject constructor() {
    fun getLucky():LuckyModel {
        return when(Random.nextInt(0, 33)){
            ...
            16 -> LuckyModel(R.drawable.card_queen_cup, R.string.app_name)
            ...
            22 -> LuckyModel(R.drawable.card_magician, R.string.app_name)
            23 -> LuckyModel(R.drawable.card_justice, R.string.app_name)
            24 -> LuckyModel(R.drawable.card_temperance, R.string.app_name)
            25 -> LuckyModel(R.drawable.card_two_pentacles, R.string.app_name)
            26 -> LuckyModel(R.drawable.card_page_wands, R.string.app_name)
            27 -> LuckyModel(R.drawable.card_lovers, R.string.app_name)
            28 -> LuckyModel(R.drawable.card_king_wands, R.string.app_name)
            29 -> LuckyModel(R.drawable.card_king_cups, R.string.app_name)
            30 -> LuckyModel(R.drawable.card_king_pentacles, R.string.app_name)
            31 -> LuckyModel(R.drawable.card_king_swords,R.string.app_name)
            32 -> LuckyModel(R.drawable.card_queen_pentacles,R.string.app_name)
